...
- 集中的“摘录与想法”资料库
- 统一收藏库，可集中查看星标文章，并粘贴网址或 HTML 保存网页正文快照
- 网页抓取自动识别正文、标题及中文编码，保存后即使原网页失效也能继续阅读文字内容
...
升级或更换新版程序不会清除已有订阅、网页收藏、归档和摘录。建议定期备份 `rrss.db`。
...
订阅内容、网页正文快照、阅读状态、归档、摘录与想法均保存在本机 SQLite 数据库中。程序只会访问你添加的订阅源、主动收藏的网页、文章图片和打开原文时所选择的网页；网页及图片下载会拒绝本机和内网地址。网页快照中的远程图片目前仍需联网加载。
